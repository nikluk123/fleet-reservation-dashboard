  ...
  return (
    <div className="relative">
      <input
        ...
        className="w-full bg-[#1a1d29] border border-gray-700 rounded-lg px-4 py-2.5 text-white placeholder-gray-600 focus:outline-none focus:border-green-500 transition-colors pr-10 text-sm"
      />
