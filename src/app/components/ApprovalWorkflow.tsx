      ...
      <div className="space-y-4">
        {pendingReservations.map((reservation) => {
          ...
          return (
            <div
              key={reservation.id}
              className="bg-app-bg border border-app-line-muted rounded-lg p-4 hover:border-blue-500/50 transition-all"
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  {reservation.notes && (
                    <div className="mt-3 pt-3 border-t border-app-line-muted">
