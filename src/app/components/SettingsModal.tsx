        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="bg-app-bg border border-app-line-muted rounded-lg p-4 flex items-center justify-between">
              ...
              <button
                onClick={toggleTheme}
                className={`relative w-11 h-6 rounded-full transition-colors overflow-hidden ${theme === 'light' ? 'bg-blue-600' : 'bg-gray-600'}`}
              >
  ...
  return (
    <div className="relative">
      <input
        ...
        className="w-full bg-app-surface border border-app-line-muted rounded-lg px-4 py-2.5 text-white placeholder-gray-600 focus:outline-none focus:border-blue-500 transition-colors pr-10 text-sm"
      />
